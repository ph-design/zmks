...
#if defined(CONFIG_ZMK_LIS2DH_TRIGGER)
...
#ifdef CONFIG_ZMK_LIS2DH_ODR_RUNTIME
...
#ifdef CONFIG_ZMK_LIS2DH_ACCEL_RANGE_RUNTIME
...
#ifdef CONFIG_ZMK_LIS2DH_ACCEL_HP_FILTERS
...
#ifdef CONFIG_ZMK_LIS2DH_SELF_TEST
...
#ifdef CONFIG_ZMK_LIS2DH_BLOCK_DATA_UPDATE
...
#define FRACTIONAL_BITS(inst)                                                                      \
    (DT_NODE_HAS_COMPAT(DT_DRV_INST(inst), zmk_lis2dh12) ||                                         \
     DT_NODE_HAS_COMPAT(DT_DRV_INST(inst), st_lis3dh))                                             \
        ? (IS_ENABLED(CONFIG_ZMK_LIS2DH_OPER_MODE_LOW_POWER) ? 0 : 2)                                  \
        : 0
...
#else
#define LIS2DH_CFG_TEMPERATURE(inst)
#endif /* CONFIG_ZMK_LIS2DH_MEASURE_TEMPERATURE */
